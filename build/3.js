...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_components_module__ = __webpack_require__(392);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__submission__ = __webpack_require__(1958);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_assessment_strategy_assessment_strategy__ = __webpack_require__(962);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_workshop__ = __webpack_require__(105);
...
var AddonModWorkshopSubmissionPage = /** @class */ (function () {
    ...
    AddonModWorkshopSubmissionPage.prototype.sendEvaluation = function () {
        ...
        return this.domUtils.isRichTextEditorEnabled().then(function (rteEnabled) {
            var inputData = _this.feedbackForm.value;
            inputData.grade = inputData.grade >= 0 ? inputData.grade : '';
            if (!rteEnabled) {
                // Rich text editor not enabled, add some HTML to the message if needed.
                inputData.text = _this.textUtils.formatHtmlLines(inputData.text);
            }
            // Try to send it to server.
            return _this.workshopProvider.evaluateSubmission(_this.workshopId, _this.submissionId, _this.courseId, inputData.text, inputData.published, inputData.grade);
        }).then(function () {
            var data = {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1959)(module)))
